...
import myActiveCell from './components/active.js'
                ...
                <div id="leftMenu"> 
                    ...
                    >
                        ...
                        <SubMenu key="sub2" title={<span><Icon type="appstore" /><span>导航二</span></span>}>
                            ...
                            <Menu.Item key="7"><Link to="/myActiveCell">activeCell</Link></Menu.Item>
                        </SubMenu>
                    </Menu>
                </div>
                <div id="rightWrap">
...
render((
    <Router history={hashHistory} >
        <Route path="/" component={Sider}>
            ...
            <Route path="myActiveCell" component={myActiveCell} />
        </Route>
    </Router>
